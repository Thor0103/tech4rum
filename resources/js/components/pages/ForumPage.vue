<template>
                ...
                >
                 ...
                 <template>
                    ...
                    <div>
                     ...
                     <a class="btn btn-primary btn-lg" style="margin-top: 10px;" href="./registration_view" role="button">Đăng Kí</a>
                    </div>
                    </div>
                    <div v-else class="user-profile clearfix" >
                     ...
                     <div class="clearfix user-profile-detail">
                         ...
                         <div style="float: left;"><a  style="margin-top: 35px; text-decoration: none; color: 	#003399;" href="/home#/forum/userprofile">{{fullname}} <br/> Điểm: {{user_score}}</a>
                            </div>
                         </div>
                         <b-button variant="success"  style="float: left; margin-left: 10px; ">
                           <router-link style="text-decoration: none; color: inherit;" to="/new-topic">Thêm bài viết</router-link></b-button>
    ...
    <div class="card-catagory-topic">
      ...
      <div
        class="user-topic"
        v-for="showtopic in topics.data"
        v-bind:key="showtopic.topic_id"
      >
        <img
          style="float: left; margin-left: 10px"
          v-bind:src="showtopic.user.image"
          alt=""
        />
        <span style="float: left; margin-left: 15px; with: 100%; height: 100%">
          <p style="with: 100%; height: 10%; margin-top: 10px">
            ...
            <router-link
              ...
              :to="{
                name: 'forum/detail',
                params: { topic_id: showtopic.topic_id },
              }"
              >{{ showtopic.title }}</router-link
            >
          </p>
          <p style="font-size: 12px; float: left; color: 	#CC3366;">
            bởi {{ showtopic.user.username }}
          </p>
          <p style="font-size: 12px; float: left; margin-left: 20px">
            1234 lượt xem
          </p>
          <p style="font-size: 12px; float: left; margin-left: 20px">
            {{showtopic.like_topic}} lượt thích
          </p>
          <p style="font-size: 12px; float: left; margin-left: 20px">
            123 lượt bình luận
          </p>
    ...
    <pagination style="margin-top: 10px; margin-right: 20px;  float: right" :data="topics" @pagination-change-page="loadTopics"></pagination>
...
export default {
  ...
  methods: {
    ...
    loadTopics: function (page = 1) {
      axios.get("api/get-all-topics?page=" + page).then((res) => {
        //console.log(res.data);
